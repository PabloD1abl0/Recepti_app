...
public class ProfileActivity extends AppCompatActivity {
    ...
    Button btn_cName,btn_cUsername, btn_cMail, btn_cPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_cName = (Button) findViewById(R.id.btn_change_name);
        btn_cUsername = (Button) findViewById(R.id.btn_change_username);
        btn_cMail = (Button) findViewById(R.id.btn_change_mail);
        btn_cPassword = (Button) findViewById(R.id.btn_change_password);
        try {
            sendGET();
